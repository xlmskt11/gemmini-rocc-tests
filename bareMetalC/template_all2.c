...
int main() {
  ...
  elem_t* A_op0 = (elem_t*) full_A + MAT_DIM_K*(MAT_DIM_I/2)*(custom0/2);
  elem_t* B_op0 = (elem_t*) full_B + (MAT_DIM_J/2)*(custom0%2);
  elem_t* C_op0 = (elem_t*) full_C + (MAT_DIM_J/2)*(custom0%2) + MAT_DIM_J*(MAT_DIM_I/2)*(custom0/2);

  elem_t* A_op1 = (elem_t*) full_A + MAT_DIM_K*(MAT_DIM_I/2)*(custom1/2);
  elem_t* B_op1 = (elem_t*) full_B + (MAT_DIM_J/2)*(custom1%2);
  elem_t* C_op1 = (elem_t*) full_C + (MAT_DIM_J/2)*(custom1%2) + MAT_DIM_J*(MAT_DIM_I/2)*(custom1/2);

  elem_t* A_op2 = (elem_t*) full_A + MAT_DIM_K*(MAT_DIM_I/2)*(custom2/2);
  elem_t* B_op2 = (elem_t*) full_B + (MAT_DIM_J/2)*(custom2%2);
  elem_t* C_op2 = (elem_t*) full_C + (MAT_DIM_J/2)*(custom2%2) + MAT_DIM_J*(MAT_DIM_I/2)*(custom2/2);

  elem_t* A_op3 = (elem_t*) full_A + MAT_DIM_K*(MAT_DIM_I/2)*(custom3/2);
  elem_t* B_op3 = (elem_t*) full_B + (MAT_DIM_J/2)*(custom3%2);
  elem_t* C_op3 = (elem_t*) full_C + (MAT_DIM_J/2)*(custom3%2) + MAT_DIM_J*(MAT_DIM_I/2)*(custom3/2);
  ...
  tiled_matmul_auto(custom0, MAT_DIM_I/2, MAT_DIM_J/2, MAT_DIM_K,
            (elem_t*)A_op0, (elem_t*)B_op0, NO_BIAS ? NULL : &full_D[0][0], (elem_t*)C_op0,
  ...
  tiled_matmul_auto(custom1, MAT_DIM_I/2, MAT_DIM_J/2, MAT_DIM_K,
            (elem_t*)A_op1, (elem_t*)B_op1, NO_BIAS ? NULL : &full_D[0][0], (elem_t*)C_op1,
            MAT_DIM_K, MAT_DIM_J, MAT_DIM_J, MAT_DIM_J,
            MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY,
            NO_ACTIVATION, ACC_SCALE_IDENTITY, 0, REPEATING_BIAS,
            false, false,
  ...
  tiled_matmul_auto(custom2, MAT_DIM_I/2, MAT_DIM_J/2, MAT_DIM_K,
            (elem_t*)A_op2, (elem_t*)B_op2, NO_BIAS ? NULL : &full_D[0][0], (elem_t*)C_op2,
            MAT_DIM_K, MAT_DIM_J, MAT_DIM_J, MAT_DIM_J,
            MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY,
            NO_ACTIVATION, ACC_SCALE_IDENTITY, 0, REPEATING_BIAS,
            false, false,
  ...
  tiled_matmul_auto(custom3, MAT_DIM_I/2, MAT_DIM_J/2, MAT_DIM_K,
            (elem_t*)A_op3, (elem_t*)B_op3, NO_BIAS ? NULL : &full_D[0][0], (elem_t*)C_op3,
            MAT_DIM_K, MAT_DIM_J, MAT_DIM_J, MAT_DIM_J,
            MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY, MVIN_SCALE_IDENTITY,
            NO_ACTIVATION, ACC_SCALE_IDENTITY, 0, REPEATING_BIAS,
            false, false,
