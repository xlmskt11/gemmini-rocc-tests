...
// made
static void multi_tiled_matmul_outer(int gemmini_num,
...
// made
static void multi_tiled_matmul(int gemmini_num,
                         size_t dim_I, size_t dim_J, size_t dim_K,
                         const elem_t *A, const elem_t *B,
                         const void *D, void *C,
                         size_t stride_A, size_t stride_B, size_t stride_D, size_t stride_C,
                         ...
                         enum tiled_matmul_type_t tiled_matmul_type)
{
  ...
  if (tiled_matmul_type == OS || tiled_matmul_type == WS)
  {
    multi_tiled_matmul_outer(gemmini_num,
                       dim_I, dim_J, dim_K,
                       A, B, D, C,
                       stride_A, stride_B, stride_D, stride_C,
                       A_scale_factor, B_scale_factor, D_scale_factor,
...
// made
static void multi_tiled_matmul_auto(int gemmini_num,
                                          size_t dim_I, size_t dim_J, size_t dim_K,
                                          const elem_t *A, const elem_t *B,
                                          const void *D, void *C,
                                          size_t stride_A, size_t stride_B, size_t stride_D, size_t stride_C,
...
#define db_max_tile_k (db_mats_in_partition / db_max_tile_i_j)
  ...
  multi_tiled_matmul(gemmini_num,
               dim_I, dim_J, dim_K,
               A, B, D, C,
               stride_A, stride_B, stride_D, stride_C,
               A_scale_factor, B_scale_factor, D_scale_factor,
